  ...
  try {
    ...
    Image.create({
      ...
      data: fs.readFileSync(
        __basedir + "../../resources/static/assets/uploadsTwo/" + req.file.filename
      ),
    }).then((image) => {
      fs.writeFileSync(
        __basedir + "../../resources/static/assets/tmpTwo/" + image.name,
        image.data
      );
...
const getListFiles = (req, res) => {
  const directoryPath = __basedir + "../../resources/static/assets/uploadsTwo/";
